...
#     val_data = load_dataset('json', data_files='validation_dataset.json', split='train')

#     train_dataset = train_data.to_iterable_dataset()
#     validation_dataset = val_data.to_iterable_dataset().take(100)
#     processed_train_dataset, processed_validation_dataset = load_datasets(train_dataset, validation_dataset, tokenizer)
#     print(len(processed_train_dataset), len(processed_validation_dataset))